"""
Django settings for UmbCon project.
...
SECRET_KEY = 'f69=+gl*xjw6_oo04*8c-v(zz2@2)yvvw)lirjybwp*zizaj+$'
...
WSGI_APPLICATION = 'UmbCon.wsgi.application'
...
LOGIN_REDIRECT_URL = '/SmartUmbrellas/'
LOGOUT_REDIRECT_URL ='/'
